...
/// A [SmartFormField] that contains a [TextField].
///
...
/// defines the [initialValue]. If this [SmartFormField] is part of a scrolling
...
/// {@tool snippet}
///
/// Creates a [SmartTextFormField] with an [InputDecoration] and validator function.
///
...
///  * [TextField], which is the underlying text field without the [SmartForm]
///    integration.
...
class _TextFormFieldState extends SmartFormFieldState<String> {
  ...
  @override
  SmartTextFormField get widget => super.widget as SmartTextFormField;
  ...
  @override
  void didUpdateWidget(SmartTextFormField oldWidget) {
